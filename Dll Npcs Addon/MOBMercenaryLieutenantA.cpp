...
/******************************************************************************/
void MOBMercenaryLieutenantA::Create()
/******************************************************************************/
{
...
/******************************************************************************/
void MOBMercenaryLieutenantA::OnPopup( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{											 	
	GiveGlobalFlag(__GLOBAL_FLAG_ADDON_MERCENARY_LIEUTENANT_A_SPAWNED, 1);
	NPCstructure::OnPopup( UNIT_FUNC_PARAM );
}
/******************************************************************************/
void MOBMercenaryLieutenantA::OnAttacked( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{
	if( target != NULL )
	{
...
/******************************************************************************/
void MOBMercenaryLieutenantA::OnDeath( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{
	INIT_HANDLER
	...
	if( target != NULL )
	{
        ...
        GiveGlobalFlag(__GLOBAL_FLAG_ADDON_MERCENARY_LIEUTENANT_A_KILLED_TIMER, CurrentRound)
...
/******************************************************************************/
void MOBMercenaryLieutenantA::OnDestroy( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{
	GiveGlobalFlag(__GLOBAL_FLAG_ADDON_MERCENARY_LIEUTENANT_A_SPAWNED, 0);
