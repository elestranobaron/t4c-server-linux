...
extern NPCstructure::NPC VicarVharmesNPC;

/******************************************************************************/
void VicarVharmes::Create()
/******************************************************************************/
{
	npc = VicarVharmesNPC;
	SET_NPC_NAME( "[12783]Vicar Vharmes" );
	npc.InitialPos.X = 0;
	npc.InitialPos.Y = 0; 
	npc.InitialPos.world = 0;
}
/******************************************************************************/
void VicarVharmes::OnDeath( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{
	INIT_HANDLER
	if( target != NULL )
	{
		IF ((CheckFlag(__FLAG_ADDON_CRYSTAL_KEY) == 0) && (CheckItem(__OBJ_CRYSTAL_VHARMES)==0))
			SHOUT(INTL( 12679, "This is impossible! AAAAAARRRRRGH!"))
			...
			GiveItem(__OBJ_CRYSTAL_VHARMES) 
		ENDIF	
	}
    CLOSE_HANDLER
...
/******************************************************************************/
void VicarVharmes::OnAttack( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{
	switch(rnd(0, 20))
	{
