...
ENDIF
IF (DWORD(CheckNPCFlag( __NPC_FLAG_MURMUNTAG_INFECTED)) > CurrentRound)  
    ...
    Conversation
      ...
      FORMAT(INTL( 1844, "{You} {have} {been} {awarded} {%u} {experience} {points.}"),(100000+(USER_LEVEL*1000)))
      GiveXP(100000+(USER_LEVEL*1000))
   #else 
   ...
   BREAK
	ENDIF
ELSEIF ((DWORD(CheckNPCFlag( __NPC_FLAG_MURMUNTAG_INFECTED )) < CurrentRound) && (CheckNPCFlag( __NPC_FLAG_MURMUNTAG_INFECTED ) != 0 ))
	Conversation
