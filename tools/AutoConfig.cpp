    ...
    if( kKey.hKey == kSecondKey.hKey ){
        ...
        if( kKey.szCompareSubKey != NULL ){
            ...
            if( kSecondKey.szCompareSubKey != NULL ){
                nStr = stricmp( kKey.szCompareSubKey, kSecondKey.szCompareSubKey );
            }else{
                nStr = stricmp( kKey.szCompareSubKey, kSecondKey.sSubKey.c_str() );
            }
        }else{
            // If a comparison string pointer was provided for the 2nd key.
            if( kSecondKey.szCompareSubKey != NULL ){
                nStr = stricmp( kKey.sSubKey.c_str(), kSecondKey.szCompareSubKey );
            }else{
                nStr = stricmp( kKey.sSubKey.c_str(), kSecondKey.sSubKey.c_str() );
            }
        }
        ...
        if( nStr == 0 ){
            ...
            if( kKey.szCompareValueName != NULL ){
                ...
                if( kSecondKey.szCompareValueName != NULL ){
                    return stricmp( kKey.szCompareValueName, kSecondKey.szCompareValueName ) < 0;
                }else{
                    return stricmp( kKey.szCompareValueName, kSecondKey.sValueName.c_str() ) < 0;
                }
            }else{
                // If a comparison string pointer was provided for the 2nd key.
                if( kSecondKey.szCompareValueName != NULL ){
                    return stricmp( kKey.sValueName.c_str(), kSecondKey.szCompareValueName ) < 0;
                }else{
                    return stricmp( kKey.sValueName.c_str(), kSecondKey.sValueName.c_str() ) < 0;
                }
            }
        }
    }
...
//////////////////////////////////////////////////////////////////////////////////////////
void CAutoConfig::ChangeDetectionThread
//////////////////////////////////////////////////////////////////////////////////////////
