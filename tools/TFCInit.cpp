...
/******************************************************************************/
{
   ...
   vWDAFilenames.push_back(sBaseFolder+"DialsoftV2Edit.WDA");
   ...
   CWDAUtils  *pWDAV2 = new CWDAUtils();
   ...
   printf( "\n- Loading T4C EditV2 Items List %d items", pWDAV2->GetNbrItemHives());
   ...
   printf( "\n- Loading T4C EditV2 Monsters List %d monsters", pWDAV2->GetNbrMonster());
   ...
   printf( "\n- Loading T4C EditV2 Spells List %d spells", pWDAV2->GetNbrSpellsHives());
   ...
   printf( "\n- Loading T4C EditV2 Arealink %d", pWDAV2->GetNbrArealink());
