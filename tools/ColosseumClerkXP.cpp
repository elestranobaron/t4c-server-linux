...
/******************************************************************************/
void ColosseumClerkXP::Create( void )
/******************************************************************************/
{
	npc = ( ColosseumClerkNPC );
	SET_NPC_NAME( "[10969]A busy-looking clerk" );  
	npc.InitialPos.X = 1605; 
	npc.InitialPos.Y = 2061;
	npc.InitialPos.world = 0;
}
/******************************************************************************/
void ColosseumClerkXP::OnInitialise( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{
...
/******************************************************************************/
void ColosseumClerkXP::OnTalk( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{
	CONSTANT Arena = 1;
	...
	InitTalk
		...
		Begin 
			...
			IF (IsInRange(8)) 
				IF (ACK_COLOSSEUM == 0) // If Colosseum XP is disallowed. 
					Conversation
						INTL( 11712, "I am truly sorry but I cannot serve you currently. I will therefore send you back to my boss.") 
					CastSpellTarget(__SPELL_NPC_CANTRIP_FLAK)
					TELEPORT(343, 492, 0)
					BREAK
				ELSE
					IF(CheckFlag(__FLAG_NUMBER_OF_REMORTS) >= 1 || CheckFlag(__FLAG_NMS_DECHU) > 0)
					...
					ELSE
						Conversation
							INTL( 10689, "The colosseum is for seraphs only. I don't know how you got here but I will have to send you back.")
						CastSpellTarget(__SPELL_NPC_CANTRIP_FLAK)
						TELEPORT(343, 492, 0)
						BREAK
					ENDIF
		...
		;} else if( ( ( msg.Find( INTL( 7311, " 1 ") ) != -1 ) || ( msg.Find( INTL( 10507, " ONE ") ) != -1 ) ) && YesNo == NumberOfOpponents) {;
			...
			SWITCH(CheckFlag(__FLAG_USER_LEVEL_SLICE))
				CASE(40)
					SUMMON("ARENAMOBXP40", 1585, 2060)
					ENDCASE
				CASE(50)
					SUMMON("ARENAMOBXP50", 1585, 2060)
					ENDCASE
				CASE(60)
					SUMMON("ARENAMOBXP60", 1585, 2060)
					ENDCASE
				CASE(70)
					SUMMON("ARENAMOBXP70", 1585, 2060)
					ENDCASE
				CASE(80)
					SUMMON("ARENAMOBXP80", 1585, 2060)
					ENDCASE
				CASE(90)
					SUMMON("ARENAMOBXP90", 1585, 2060)
					ENDCASE
				CASE(100)
					SUMMON("ARENAMOBXP100", 1585, 2060)
					ENDCASE
				CASE(110)
					SUMMON("ARENAMOBXP110", 1585, 2060)
					ENDCASE
				CASE(120)
					SUMMON("ARENAMOBXP120", 1585, 2060)
					ENDCASE
				CASE(130)
					SUMMON("ARENAMOBXP130", 1585, 2060)
					ENDCASE
				CASE(140)
					SUMMON("ARENAMOBXP140", 1585, 2060)
					ENDCASE
				CASE(150)
					SUMMON("ARENAMOBXP150", 1585, 2060)
					ENDCASE
				CASE(160)
					SUMMON("ARENAMOBXP160", 1585, 2060)
					ENDCASE
				CASE(170)
					SUMMON("ARENAMOBXP170", 1585, 2060)
					ENDCASE
				CASE(180)
					SUMMON("ARENAMOBXP180", 1585, 2060)
					ENDCASE
				CASE(190)
					SUMMON("ARENAMOBXP190", 1585, 2060)
					ENDCASE
				CASE(200)
					SUMMON("ARENAMOBXP200", 1585, 2060)
					ENDCASE
				CASE(225)
					SUMMON("ARENAMOBXP225", 1585, 2060)
					ENDCASE
				CASE(250)
					SUMMON("ARENAMOBXP250", 1585, 2060)
					ENDCASE
				CASE(275)
					SUMMON("ARENAMOBXP275", 1585, 2060)
					ENDCASE
				CASE(300)
					SUMMON("ARENAMOBXP300", 1585, 2060)
					ENDCASE
				CASE(325)
					SUMMON("ARENAMOBXP325", 1585, 2060)
					ENDCASE
				CASE(350)
					SUMMON("ARENAMOBXP350", 1585, 2060)
					ENDCASE
				CASE(375)
					SUMMON("ARENAMOBXP375", 1585, 2060)
					ENDCASE
				CASE(400)
					SUMMON("ARENAMOBXP400", 1585, 2060)
					ENDCASE
				CASE(425)
					SUMMON("ARENAMOBXP425", 1585, 2060)
					ENDCASE
				CASE(450)
					SUMMON("ARENAMOBXP450", 1585, 2060)
					ENDCASE
				CASE(475)
					SUMMON("ARENAMOBXP475", 1585, 2060)
					ENDCASE
				CASE(500)
					SUMMON("ARENAMOBXP500", 1585, 2060)
					ENDCASE
			ENDSWITCH
		...
		;} else if( ( ( msg.Find( INTL( 10509, " 2 ") ) != -1 ) || ( msg.Find( INTL( 10510, " TWO ") ) != -1 ) ) && YesNo == NumberOfOpponents) {;
			...
			SWITCH(CheckFlag(__FLAG_USER_LEVEL_SLICE))
				CASE(40)
					SUMMON("ARENAMOBXP40", 1605, 2080)
					SUMMON("ARENAMOBXP40", 1585, 2080)
					ENDCASE
				CASE(50)
					SUMMON("ARENAMOBXP50", 1605, 2080)
					SUMMON("ARENAMOBXP50", 1585, 2080)
					ENDCASE
				CASE(60)
					SUMMON("ARENAMOBXP60", 1605, 2080)
					SUMMON("ARENAMOBXP60", 1585, 2080)
					ENDCASE
				CASE(70)
					SUMMON("ARENAMOBXP70", 1605, 2080)
					SUMMON("ARENAMOBXP70", 1585, 2080)
					ENDCASE
				CASE(80)
					SUMMON("ARENAMOBXP80", 1605, 2080)
					SUMMON("ARENAMOBXP80", 1585, 2080)
					ENDCASE
				CASE(90)
					SUMMON("ARENAMOBXP90", 1605, 2080)
					SUMMON("ARENAMOBXP90", 1585, 2080)
					ENDCASE
				CASE(100)
					SUMMON("ARENAMOBXP100", 1605, 2080)
					SUMMON("ARENAMOBXP100", 1585, 2080)
					ENDCASE
				CASE(110)
					SUMMON("ARENAMOBXP110", 1605, 2080)
					SUMMON("ARENAMOBXP110", 1585, 2080)
					ENDCASE
				CASE(120)
					SUMMON("ARENAMOBXP120", 1605, 2080)
					SUMMON("ARENAMOBXP120", 1585, 2080)
					ENDCASE
				CASE(130)
					SUMMON("ARENAMOBXP130", 1605, 2080)
					SUMMON("ARENAMOBXP130", 1585, 2080)
					ENDCASE
				CASE(140)
					SUMMON("ARENAMOBXP140", 1605, 2080)
					SUMMON("ARENAMOBXP140", 1585, 2080)
					ENDCASE
				CASE(150)
					SUMMON("ARENAMOBXP150", 1605, 2080)
					SUMMON("ARENAMOBXP150", 1585, 2080)
					ENDCASE
				CASE(160)
					SUMMON("ARENAMOBXP160", 1605, 2080)
					SUMMON("ARENAMOBXP160", 1585, 2080)
					ENDCASE
				CASE(170)
					SUMMON("ARENAMOBXP170", 1605, 2080)
					SUMMON("ARENAMOBXP170", 1585, 2080)
					ENDCASE
				CASE(180)
					SUMMON("ARENAMOBXP180", 1605, 2080)
					SUMMON("ARENAMOBXP180", 1585, 2080)
					ENDCASE
				CASE(190)
					SUMMON("ARENAMOBXP190", 1605, 2080)
					SUMMON("ARENAMOBXP190", 1585, 2080)
					ENDCASE
				CASE(200)
					SUMMON("ARENAMOBXP200", 1605, 2080)
					SUMMON("ARENAMOBXP200", 1585, 2080)
					ENDCASE
				CASE(225)
					SUMMON("ARENAMOBXP225", 1605, 2080)
					SUMMON("ARENAMOBXP225", 1585, 2080)
					ENDCASE
				CASE(250)
					SUMMON("ARENAMOBXP250", 1605, 2080)
					SUMMON("ARENAMOBXP250", 1585, 2080)
					ENDCASE
				CASE(275)
					SUMMON("ARENAMOBXP275", 1605, 2080)
					SUMMON("ARENAMOBXP275", 1585, 2080)
					ENDCASE
				CASE(300)
					SUMMON("ARENAMOBXP300", 1605, 2080)
					SUMMON("ARENAMOBXP300", 1585, 2080)
					ENDCASE
				CASE(325)
					SUMMON("ARENAMOBXP325", 1605, 2080)
					SUMMON("ARENAMOBXP325", 1585, 2080)
					ENDCASE
				CASE(350)
					SUMMON("ARENAMOBXP350", 1605, 2080)
					SUMMON("ARENAMOBXP350", 1585, 2080)
					ENDCASE
				CASE(375)
					SUMMON("ARENAMOBXP375", 1605, 2080)
					SUMMON("ARENAMOBXP375", 1585, 2080)
					ENDCASE
				CASE(400)
					SUMMON("ARENAMOBXP400", 1605, 2080)
					SUMMON("ARENAMOBXP400", 1585, 2080)
					ENDCASE
				CASE(425)
					SUMMON("ARENAMOBXP425", 1605, 2080)
					SUMMON("ARENAMOBXP425", 1585, 2080)
					ENDCASE
				CASE(450)
					SUMMON("ARENAMOBXP450", 1605, 2080)
					SUMMON("ARENAMOBXP450", 1585, 2080)
					ENDCASE
				CASE(475)
					SUMMON("ARENAMOBXP475", 1605, 2080)
					SUMMON("ARENAMOBXP475", 1585, 2080)
					ENDCASE
				CASE(500)
					SUMMON("ARENAMOBXP500", 1605, 2080)
					SUMMON("ARENAMOBXP500", 1585, 2080)
					ENDCASE
			ENDSWITCH
			CastSpellTarget(__SPELL_MOB_COLOSSEUM_UPGRADE_SPELL)
			GiveFlag(__FLAG_USER_HAS_CHANGED_DIFFICULTY_LEVEL, 0)
		...
		Command2(INTL( 7383, "ARENA"), INTL( 10737, "COLOSSEUM"))
			INTL( 10738, "The arena is used by adventurers of all levels to better hone their skills and gain valuable experience in \"battle\", as well "
