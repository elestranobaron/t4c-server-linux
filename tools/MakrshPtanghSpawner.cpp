...
/******************************************************************************/
{
	IF(CheckGlobalFlag(__GLOBAL_FLAG_MAKRSH_PTANGH_IS_FIGHTING) == 1)
		IF(CurrentRound < DWORD(CheckGlobalFlag(__GLOBAL_FLAG_MAKRSH_PTANGH_DEAD_TIMER)))
			GiveGlobalFlag(__GLOBAL_FLAG_MAKRSH_PTANGH_IS_FIGHTING, 2)
			SUMMON("MAKRSHPTANGH", 2265, 295)
		ELSEIF(CurrentRound >= DWORD(CheckGlobalFlag(__GLOBAL_FLAG_MAKRSH_PTANGH_DEAD_TIMER) + 24000))
			GiveGlobalFlag(__GLOBAL_FLAG_MAKRSH_PTANGH_IS_FIGHTING, 2)
			SUMMON("MAKRSHPTANGH", 2265, 295)
		ENDIF
	ENDIF
