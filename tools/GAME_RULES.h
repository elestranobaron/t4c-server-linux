...
Add PVP System and change death penelaty by NightMare (29/06/2009)
/******************************************************************************/
...
/******************************************************************************/
class __declspec(dllexport) GAME_RULES  
/******************************************************************************/
{
public:
	GAME_RULES();
   ...
   static UINT NMPVPCanAttack    ( Unit *lpuFirst, Unit *lpuSecond );

	static void DeathPenalties( Character *chUser, Unit *lpAttacker, TemplateList< Unit > *invSpillList, TemplateList< Unit > *equipSpillList, DWORD &goldLoss ,BOOL bPVPChnageDrop,double dPVPNewDrop);
