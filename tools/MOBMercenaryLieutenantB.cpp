...
/******************************************************************************/
void MOBMercenaryLieutenantB::Create()
/******************************************************************************/
{
...
/******************************************************************************/
void MOBMercenaryLieutenantB::OnPopup( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{											 	
	GiveGlobalFlag(__GLOBAL_FLAG_ADDON_MERCENARY_LIEUTENANT_B_SPAWNED, 1);
	NPCstructure::OnPopup( UNIT_FUNC_PARAM );
}
/******************************************************************************/
void MOBMercenaryLieutenantB::OnAttacked( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{
	if( target != NULL )
	{
...
/******************************************************************************/
void MOBMercenaryLieutenantB::OnDeath( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{
	INIT_HANDLER
	...
	if( target != NULL )
	{
		...
		GiveGlobalFlag(__GLOBAL_FLAG_ADDON_MERCENARY_LIEUTENANT_B_KILLED_TIMER, CurrentRound)
		IF(DWORD(CheckGlobalFlag(__GLOBAL_FLAG_ADDON_MERCENARY_LIEUTENANT_A_KILLED_TIMER)) >= (CurrentRound - 3600)) 
			IF(DWORD(CheckGlobalFlag(__GLOBAL_FLAG_ADDON_MERCENARY_LIEUTENANT_B_KILLED_TIMER)) >= (CurrentRound - 3600))
				IF(DWORD(CheckGlobalFlag(__GLOBAL_FLAG_ADDON_MERCENARY_LIEUTENANT_C_KILLED_TIMER)) >= (CurrentRound - 3600))
...
/******************************************************************************/
void MOBMercenaryLieutenantB::OnDestroy( UNIT_FUNC_PROTOTYPE )
/******************************************************************************/
{
	GiveGlobalFlag(__GLOBAL_FLAG_ADDON_MERCENARY_LIEUTENANT_B_SPAWNED, 0);
