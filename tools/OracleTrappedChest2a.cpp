...
void OracleTrappedChest2a::OnAttacked( UNIT_FUNC_PROTOTYPE ){
}

void OracleTrappedChest2a::Create( void )
{
      npc = ( OracleChestNPC );
...
void OracleTrappedChest2a::OnInitialise( UNIT_FUNC_PROTOTYPE ){
...
void OracleTrappedChest2a::OnTalk( UNIT_FUNC_PROTOTYPE )
///////////////////////////////////////////////////////////////////////////
...
IF(IsInRange(4))
	...
	ELSEIF(CheckGlobalFlag(__GLOBAL_FLAG_TRAPPED_CHEST_A) == 0)
		...
		IF(CheckGlobalFlag(__GLOBAL_FLAG_TRAPPED_CHEST_A) == 2)
		...
		ENDIF
	ELSEIF(CheckGlobalFlag(__GLOBAL_FLAG_TRAPPED_CHEST_A) == 2)
		GiveItem(__OBJ_SCORCHED_METAL_KEY)
		PRIVATE_SYSTEM_MESSAGE(INTL( 9375, "You find a scorched metal key inside the chest."))
	ELSE
		PRIVATE_SYSTEM_MESSAGE(INTL( 9353, "The chest is trapped!"))
