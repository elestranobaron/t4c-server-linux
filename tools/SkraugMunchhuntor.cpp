...
extern NPCstructure::NPC SkraugMunchhuntorNPC;

void SkraugMunchhuntor::Create(){
   npc = SkraugMunchhuntorNPC;
   SET_NPC_NAME( "[10924]Skraug munchhuntor" );
   npc.InitialPos.X = 0; 
   npc.InitialPos.Y = 0; 
	npc.InitialPos.world = 0;
}

void SkraugMunchhuntor::OnAttack( UNIT_FUNC_PROTOTYPE )
{  
	switch(rnd(0, 40))	 
	{		
...
void SkraugMunchhuntor::OnAttacked( UNIT_FUNC_PROTOTYPE )
{ 
	switch(rnd(0, 40))	 
	{
...
void SkraugMunchhuntor::OnDeath( UNIT_FUNC_PROTOTYPE )
{
	switch(rnd(0, 40))	 
	{	
