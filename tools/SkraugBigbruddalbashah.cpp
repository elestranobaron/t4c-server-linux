...
extern NPCstructure::NPC SkraugBigbruddalbashahNPC;

void SkraugBigbruddalbashah::Create(){
   npc = SkraugBigbruddalbashahNPC;
   SET_NPC_NAME( "[10916]Skraug bigbruddalbashah" );
   npc.InitialPos.X = 0; 
   npc.InitialPos.Y = 0; 
   npc.InitialPos.world = 0;
}

void SkraugBigbruddalbashah::OnAttack( UNIT_FUNC_PROTOTYPE )
{  
	switch(rnd(0, 40))	 
	{		
...
void SkraugBigbruddalbashah::OnAttacked( UNIT_FUNC_PROTOTYPE )
{ 
	switch(rnd(0, 40))	 
	{
...
void SkraugBigbruddalbashah::OnDeath( UNIT_FUNC_PROTOTYPE )
{
	switch(rnd(0, 40))	 
	{	
