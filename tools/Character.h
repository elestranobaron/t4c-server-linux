...
//	void save_character();
   ...
   inline BOOL CastSpellNoCheck( WORD wSpellID, Unit *uTarget );
   inline BOOL CastSpellNoCheckFull( WORD wSpellID, Unit *uTarget );
	inline BOOL CastSpellDirect( WORD wSpellID, Unit *uTarget );
	inline BOOL CastSpell( WORD wSpellID, WorldPos wlPos );
   inline BOOL CastSpellPosSystem( WORD wSpellID, WorldPos wlPos );
