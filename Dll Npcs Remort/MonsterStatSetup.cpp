...
/******************************************************************************/
		...
		MOB_ATTACK_DMG_ROLL   ( "1d344+309" )
		MOB_ATTACK_PERCENTAGE ( 40 )

		MOB_ITEM( __OBJ_BLACK_LOCUST_COMPOSITE_BOW_3, 4 ) 
		MOB_ITEM( __OBJ_ANCIENT_TWO_HANDED_SWORD_3, 4 ) 
		MOB_ITEM( __OBJ_ANCIENT_BROAD_AXE_3, 4 ) 
		MOB_ITEM( __OBJ_ANCIENT_MORNINGSTAR_3, 4 ) 
		MOB_ITEM( __OBJ_SHIELD_OF_THE_AGES, 4 ) 
		MOB_ITEM( __OBJ_ANCIENT_PLATEMAIL_ARMOR, 4 ) 
		MOB_ITEM( __OBJ_ANCIENT_PLATE_PROTECTOR, 4 ) 
		MOB_ITEM( __OBJ_ANCIENT_PLATEMAIL_GAUNTLETS, 4 ) 
		MOB_ITEM( __OBJ_ANCIENT_PLATEMAIL_HELMET, 4 ) 
		MOB_ITEM( __OBJ_ANCIENT_PLATEMAIL_LEGGINGS, 4 ) 
		MOB_ITEM( __OBJ_ANCIENT_PLATEMAIL_BOOTS, 4 ) 
...
/******************************************************************************/
	// Start of mad madrigan's mad house
...
/******************************************************************************/
	// start of xp colosseum monsters
