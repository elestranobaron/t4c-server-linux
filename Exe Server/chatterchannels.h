...
Add Guild CC Validation by NightMare (06/27/2009)
/******************************************************************************/
...
public:
   ...
   private:
      ...
      typedef std::set< ChannelUser, UserCompare > UserCont;
   ...
   bool AddCCPlayer( Players *lpPlayer, ChannelID ciChannelID, std::string csPassword = "" ,bool bValidGuildCC = true);
   ...
   void TalkSystem( CString csSender, ChannelID ciChannelID, std::string csMessage );
   ...
   void SendChannelUsers2( Players *lpPlayer, ChannelID ciChannelID );
   char GetPlayerGodTitleRight(Character* pUser, bool &bHidden);
...
private:    
   ...
   public:
      ...
      {
         return( _stricmp( csLeft.c_str(), csRight.c_str() ) < 0 );
      }
   };
