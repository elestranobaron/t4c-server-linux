...
public:
    ...
    void RegisterThread( HANDLE hThreadHandle, CString csThreadName, DWORD dwMaxTimeout = DEADLOCK_TIME, int nThreadId = GetCurrentThreadId() );
    ...
    static void SuspendDeadlockDetection( DWORD dwDelay = INFINITE );
