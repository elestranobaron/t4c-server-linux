...
#ifndef _WIN32
      /* LP64 WDA (WDASpells.cpp) : 3 bools + icon, pas les 7 stats Win32. */
      m_psSpellList[i].chLineOfSight = get_byte();
      m_psSpellList[i].chSkillExclu = 0;
...
#ifndef _WIN32
      /* LP64 WDA (WDAObjects.cpp) : pas dwBuyFlagID / strSellPrice / dParadePC. */
      m_psItemList[i].dwBuyFlagID = 0;
      m_psItemList[i].dwSellPrice = get_dword();
      m_psItemList[i].dwStrSellPrice = 0;
