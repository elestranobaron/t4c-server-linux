...
//////////////////////////////////////////////////////////////////////////////////////////
{
	...
	tm *tmTime = localtime( &tCalc );
		...
		printf( "\n-----                                                     " 
                "\nServer started on %s                                      "
			    "\nPress F5  to switch on rain.                              " // steph d�sactivation +fog
			    "\nPress F6  to switch off rain.                             " // steph d�sactivation +fog
...
wsprintf(lpvMessage, "Un message du serveur" );
	...
	WriteFile(theApp.hPipeMain,"#Stop ",6,&cbWritten,NULL); 
                    ...
                    break;
                case 63:
                    printf( "\r\nPress F5 again twice to switch on Rain." ); // steph d�sactivation +Fog
                    if( getch() == 0 && getch() == 63 && getch() == 0 && getch() == 63 ){
                        printf( " Rain switched on.\n" ); // steph d�sactivation +Fog
                    ...
                    break;
                case 64:
                    printf( "\r\nPress F6 again twice to switch off Rain." ); // steph d�sactivation +Fog
