...
/******************************************************************************/
class __declspec(dllexport) Creatures : public Unit
/******************************************************************************/
{
public:
	Creatures();
   ...
   BOOL CanChangeTargetAA( void );
   void SetChangeTargetAA( BOOL boChangeTargetAA );

   DWORD GetFriendlyID( void );
   void SetFriendlyID( DWORD dwID );
    ...
    void SetForceAttack( BOOL boFA );
    BOOL IsForceAttack( void );
