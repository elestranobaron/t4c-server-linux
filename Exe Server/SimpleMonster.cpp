...
void SimpleMonster::OnInitialise( UNIT_FUNC_PROTOTYPE )// self/medium etc)
/******************************************************************************/
{
   ...
   self->SetFriendlyID( npc.iFriendlyID );
	...
	self->Do( wandering,"SimpleMonster::OnInitialise" );
...
void SimpleMonster::OnPopup( UNIT_FUNC_PROTOTYPE )// prototype
/******************************************************************************/
{
