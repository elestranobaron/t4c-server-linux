...
Add BOW Attack by Nightmare (27/06/2009)
/******************************************************************************/
...
typedef struct _MONSTER_ATTACK
{
    ...
    virtual int __declspec( dllexport) Attack( Unit *self, Unit *target );
    ...
    const virtual BYTE GetType( void ){
...
typedef struct _MONSTER_SPELL_ATTACK : public MONSTER_ATTACK
{
    ...
    int __declspec( dllexport ) Attack( Unit *self, Unit *target );
...
/******************************************************************************/
// Special Bow attacks for monsters.
typedef struct _MONSTER_BOW_ATTACK : public MONSTER_ATTACK{
    _MONSTER_BOW_ATTACK( void )
    {
       wSpellID = 0;
    }
    ...
    const virtual BYTE GetType( void ){ return BOW_ATTACK; };
} MONSTER_BOW_ATTACK, *LPMONSTER_BOW_ATTACK;
...
/******************************************************************************/
struct __declspec( dllexport ) MonsterStructure
{
    MonsterStructure();
   ...
   BOOL boChangeTargetAA;	// TRUE if the monster has an attack, FALSE otherwise.
   DWORD iFriendlyID;
