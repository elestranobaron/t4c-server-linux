...
#define LOG_AH              11
#define LOG_ACHAT_NMS       12
#define LOG_SPECIAL_ITEMS   13
#define LOG_SANCTION        14
#define LOG_MONSTERS        15
#define LOG_GUILDHIST       16
#define LOG_GUILDCHEST      17
#define LOG_BDEXTCH         18
#define LOG_PROFESSION      19
#define LOG_INTERRP         20
#define LOG_ARENA           21
#define LOG_EVENTS          22
#define NB_LOG_TYPES        23
...
public:
	...
	static void SaveToLog( DWORD dwType, WORD wLogLevels, const char *szText, ...);
	 static void SaveDeathLog(String &strVictime,String &strAssassin, int dwType, int dwArene = 0);
...
// END : Mestoph -> Add Cheat Log
#define _LOG_AH { CT4CLog::SaveToLog(LOG_AH,
#define _LOG_ACHAT_NMS { CT4CLog::SaveToLog(LOG_ACHAT_NMS,
#define _LOG_SPECIAL_ITEMS { CT4CLog::SaveToLog(LOG_SPECIAL_ITEMS,
#define _LOG_SANCTION { CT4CLog::SaveToLog(LOG_SANCTION,
#define _LOG_MONSTERS { CT4CLog::SaveToLog(LOG_MONSTERS,
#define _LOG_GUILDHIST { CT4CLog::SaveToLog(LOG_GUILDHIST,
#define _LOG_GUILDCHEST { CT4CLog::SaveToLog(LOG_GUILDCHEST,
#define _LOG_BDEXTCH { CT4CLog::SaveToLog(LOG_BDEXTCH,
#define _LOG_PROFESSION { CT4CLog::SaveToLog(LOG_PROFESSION,
#define _LOG_INTERRP { CT4CLog::SaveToLog(LOG_INTERRP,
#define _LOG_ARENA { CT4CLog::SaveToLog(LOG_ARENA,
#define _LOG_EVENTS { CT4CLog::SaveToLog(LOG_EVENTS,
