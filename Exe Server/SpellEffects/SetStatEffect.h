...
Add many new stats... ,GOLD ,LUCK, MANA, MAX_MANA, HP, etc etc by Nightmare 928/06/2009)
/******************************************************************************/
...
private:
	enum { STR, END, AGI, WIS, INT, APPEARANCE, 
		...
		AIR_RESIST, DARK_RESIST, EARTH_RESIST, FIRE_RESIST, LIGHT_RESIST, WATER_RESIST,GOLD ,
		LUCK, MANA, MAX_MANA, HP, MAX_HP, LEVEL, XP, GENDER,
		STATPOINTS_GIVE, STATPOINTS_SET, SKILLPOINTS_GIVE, SKILLPOINTS_SET, SKILLPOINTS_USE };
