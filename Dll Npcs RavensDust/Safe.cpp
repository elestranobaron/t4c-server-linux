...
/******************************************************************************/
{
	...
	npc.InitialPos.X = 2797;//1372; 
	npc.InitialPos.Y = 222;//2323;
...
/******************************************************************************/
{
	InitTalk
		...
		ParamCmd(INTL( 6211, "RIGHT $"))
			""
			IF ((DWORD(CheckGlobalFlag(__GLOBAL_BANK_HAS_BEEN_ROBBED)) > CurrentRound) && (CheckGlobalFlag(__GLOBAL_BANK_HAS_BEEN_ROBBED) != 0))
				Conversation
