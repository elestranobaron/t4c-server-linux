...
void OracleTrappedChest6b::OnAttacked( UNIT_FUNC_PROTOTYPE ){
}

void OracleTrappedChest6b::Create( void )
{
      npc = ( OracleChestNPC );
...
void OracleTrappedChest6b::OnInitialise( UNIT_FUNC_PROTOTYPE ){
...
void OracleTrappedChest6b::OnTalk( UNIT_FUNC_PROTOTYPE )
///////////////////////////////////////////////////////////////////////////
...
IF(IsInRange(4))
	...
	ELSEIF(CheckGlobalFlag(__GLOBAL_FLAG_TRAPPED_CHEST_B) == 0)
		...
		IF(CheckGlobalFlag(__GLOBAL_FLAG_TRAPPED_CHEST_B) == 6)
		...
		ENDIF
	ELSEIF(CheckGlobalFlag(__GLOBAL_FLAG_TRAPPED_CHEST_B) == 6)
		GiveItem(__OBJ_SCORCHED_METAL_KEY)
		PRIVATE_SYSTEM_MESSAGE(INTL( 9375, "You find a scorched metal key inside the chest."))
	ELSE
		PRIVATE_SYSTEM_MESSAGE(INTL( 9353, "The chest is trapped!"))
