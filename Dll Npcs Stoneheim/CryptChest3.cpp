...
void CryptChest3::OnAttacked( UNIT_FUNC_PROTOTYPE ){
}

void CryptChest3::OnHit( UNIT_FUNC_PROTOTYPE ){
}

void CryptChest3::Create( void )
{
      npc = ( OracleChestNPC );
      SET_NPC_NAME( "[10840]wooden chest" );  
      npc.InitialPos.X = 561; 
      npc.InitialPos.Y = 1061;
      npc.InitialPos.world = 1;
}

void CryptChest3::OnInitialise( UNIT_FUNC_PROTOTYPE ){
...
void CryptChest3::OnTalk( UNIT_FUNC_PROTOTYPE )
///////////////////////////////////////////////////////////////////////////
...
IF(IsInRange(4))
	IF(CheckItem(__OBJ_DEW_COVERED_METAL_KEY) >= 1)
		...
		ENDIF
		IF(CheckFlag(__FLAG_CRYPT_RANDOM_CHEST) == 3)
