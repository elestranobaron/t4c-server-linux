...
void OracleChest15::OnAttacked( UNIT_FUNC_PROTOTYPE ){
}

void OracleChest15::Create( void )
{
      npc = ( OracleChestNPC );
      SET_NPC_NAME( "[10840]wooden chest" );  
      npc.InitialPos.X = 2798; 
      npc.InitialPos.Y = 2354;
      npc.InitialPos.world = 2;
}

void OracleChest15::OnInitialise( UNIT_FUNC_PROTOTYPE ){
...
void OracleChest15::OnTalk( UNIT_FUNC_PROTOTYPE )
///////////////////////////////////////////////////////////////////////////
