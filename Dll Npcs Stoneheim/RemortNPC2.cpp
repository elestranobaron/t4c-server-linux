...
""
IF(USER_TRUE_STR - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) == 0)
	Conversation
...
ELSEIF(USER_TRUE_STR - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 3)
	Conversation
	INTL( 10337, "To increase your strength attribute by 1, you will need to spend 2 points of energy. Is this acceptable?")
	SetYesNo(IncreaseStrength)
ELSEIF(USER_TRUE_STR - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 6)
	Conversation
	INTL( 10338, "To increase your strength attribute by 1, you will need to spend 3 points of energy. Is this acceptable?")
	SetYesNo(IncreaseStrength)
ELSEIF(USER_TRUE_STR - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) == 7)
	Conversation
	INTL( 10339, "To increase your strength attribute by 1, you will need to spend 4 points of energy. Is this acceptable?")
	SetYesNo(IncreaseStrength)
ELSEIF(USER_TRUE_STR - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 9)
	Conversation
...
""
IF(USER_TRUE_AGI - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) == 0)
	Conversation
...
ELSEIF(USER_TRUE_AGI - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 3)
	Conversation
	INTL( 10344, "To increase your agility attribute by 1, you will need to spend 2 points of energy. Is this acceptable?")
	SetYesNo(IncreaseAgility)
ELSEIF(USER_TRUE_AGI - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 6)
	Conversation
	INTL( 10345, "To increase your agility attribute by 1, you will need to spend 3 points of energy. Is this acceptable?")
	SetYesNo(IncreaseAgility)
ELSEIF(USER_TRUE_AGI - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) == 7)
	Conversation
	INTL( 10346, "To increase your agility attribute by 1, you will need to spend 4 points of energy. Is this acceptable?")
	SetYesNo(IncreaseAgility)
ELSEIF(USER_TRUE_AGI - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 9)
	Conversation
...
""
IF(USER_TRUE_END - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) == 0)
	Conversation
...
ELSEIF(USER_TRUE_END - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 3)
	Conversation
	INTL( 10351, "To increase your endurance attribute by 1, you will need to spend 2 points of energy. Is this acceptable?")
	SetYesNo(IncreaseEndurance)
ELSEIF(USER_TRUE_END - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 6)
	Conversation
	INTL( 10352, "To increase your endurance attribute by 1, you will need to spend 3 points of energy. Is this acceptable?")
	SetYesNo(IncreaseEndurance)
ELSEIF(USER_TRUE_END - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) == 7)
	Conversation
	INTL( 10353, "To increase your endurance attribute by 1, you will need to spend 4 points of energy. Is this acceptable?")
	SetYesNo(IncreaseEndurance)
ELSEIF(USER_TRUE_END - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 9)
	Conversation
...
""
IF(USER_TRUE_INT - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) == 0)
	Conversation
...
ELSEIF(USER_TRUE_INT - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 3)
	Conversation
	INTL( 10358, "To increase your intelligence attribute by 1, you will need to spend 2 points of energy. Is this acceptable?")
	SetYesNo(IncreaseIntelligence)
ELSEIF(USER_TRUE_INT - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 6)
	Conversation
	INTL( 10359, "To increase your intelligence attribute by 1, you will need to spend 3 points of energy. Is this acceptable?")
	SetYesNo(IncreaseIntelligence)
ELSEIF(USER_TRUE_INT - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) == 7)
	Conversation
	INTL( 10360, "To increase your intelligence attribute by 1, you will need to spend 4 points of energy. Is this acceptable?")
	SetYesNo(IncreaseIntelligence)
ELSEIF(USER_TRUE_INT - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 9)
	Conversation
...
""
IF(USER_TRUE_WIS - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) == 0)
	Conversation
...
ELSEIF(USER_TRUE_WIS - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 3)
	Conversation
	INTL( 10364, "To increase your wisdom attribute by 1, you will need to spend 2 points of energy. Is this acceptable?")
	SetYesNo(IncreaseWisdom)
ELSEIF(USER_TRUE_WIS - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 6)
	Conversation
	INTL( 10365, "To increase your wisdom attribute by 1, you will need to spend 3 points of energy. Is this acceptable?")
	SetYesNo(IncreaseWisdom)
ELSEIF(USER_TRUE_WIS - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) == 7)
	Conversation
	INTL( 10366, "To increase your wisdom attribute by 1, you will need to spend 4 points of energy. Is this acceptable?")
	SetYesNo(IncreaseWisdom)
ELSEIF(USER_TRUE_WIS - (20 + (CheckFlag(__FLAG_NUMBER_OF_REMORTS) + CheckFlag(__FLAG_NMS_DECHU)) * 5) <= 9)
	Conversation
