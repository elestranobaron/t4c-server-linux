...
CONSTANT nNumHints = 25; // If you add a hint in her ball reading, update this value! 
CONSTANT PayHint = 1;
...
""
IF((DWORD(CheckFlag(__QUEST_TIMER_CHRYSEIDA_HINTS)) <= CurrentRound) || (CurrentRound < DWORD(CheckFlag(__QUEST_TIMER_CHRYSEIDA_HINTS)-72000)) )
	SWITCH(rnd.roll(dice (1,nNumHints)) ) 
      ...
      CASE(23)
      CASE(24)
			IF(CheckFlag(__FLAG_QUETE_DE_VILLIS) == 1)
				Conversation
				INTL( 15360, "I fear I see... nothing. Perhaps I can try again, if you *really* need a \"hint\"?")
				GiveFlag(__FLAG_QUETE_DE_VILLIS,2)
			ELSE
				Conversation
				INTL( 9436, "I fear I see... nothing. Perhaps I can try again, if you *really* need a \"hint\"?")
			ENDIF
...
""
IF(CheckFlag(__FLAG_QUETE_DE_VILLIS) == 2)
	Conversation
	INTL( 15361, "I fear I see... nothing. Perhaps I can try again, if you *really* need a \"hint\"?")
	GiveFlag(__FLAG_QUETE_DE_VILLIS,3)
ELSE
	Conversation
	INTL( 15362, "I fear I see... nothing. Perhaps I can try again, if you *really* need a \"hint\"?")
ENDIF
